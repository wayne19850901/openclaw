---
name: gstack-open-browser
version: 0.2.0
description: "启动浏览器 / open-gstack-browser：AI 控制的 Chromium，带侧边栏。触发词：连接浏览器、connect-chrome"
...
12. **Non-ASCII characters — write directly, never  -escape.** When any
    string field (question, option label, option description) contains
    Chinese (繁體/簡體), Japanese, Korean, or other non-ASCII text, emit
    the literal UTF-8 characters in the JSON string. **Never escape them
    as ` XXXX`.** Claude Code's tool parameter pipe is UTF-8 native
    ...
    Wrong: `"question": "請選擇 XXXX XXXX XXXX XXXX"`
...
- [ ] Non-ASCII characters (CJK / accents) written directly, NOT  -escaped
